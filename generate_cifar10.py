...
def generate_cifar10(dir_path, num_clients, num_labels, niid=False, real=True, partition=None):
    ...
    trainset = torchvision.datasets.CIFAR10(
        root="cifar10_rawdata", train=True, download=True, transform=transform)
    testset = torchvision.datasets.CIFAR10(
        root="cifar10_rawdata", train=False, download=True, transform=transform)
